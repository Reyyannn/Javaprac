...
public class String7 {
	...
	public static void main(String[] args) {
		...
		int numbers[][] = { { 2, 4, 6 }, { 6, 8, 10 }, { 12, 14, 16 } };
		for (int[] c1 : numbers) {
		...
		// program 4
		int numms[][] = { { 100, 200, 200 }, { 300, 400, 300 }, { 400, 40, 50 } };
		for (int[] row1 : numms) {
		...
		int[][][] j1 = { { { 50, 50, 66 }, { 88, 99, 77 } }, { { 1, 2, 3 }, { 5, 6, 7 } }
